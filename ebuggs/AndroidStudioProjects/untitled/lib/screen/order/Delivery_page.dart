...
class FinalorderTrackingPage extends StatefulWidget {
  const FinalorderTrackingPage ({super.key});

  @override
  State<FinalorderTrackingPage> createState() => _FinalorderTrackingPageState();
}

class _FinalorderTrackingPageState extends State<FinalorderTrackingPage > {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) =>OrderDetailsPage(), // navigate to actual details page
                      ),
                    );
                  },
                ),
            ...
            Column(
              children: [
                const Divider(color: Color(0xFFCDCDCD), thickness: 1, height: 1),
                InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ReviewPage(), // your target page
                      ),
                    );
                  },
                  child: Padding(
...
class ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double iconSize = screenWidth > 900
        ...
        ? 20
        : 18;
    double paddingSize = screenWidth * 0.0;
